...
//!
//! 1. source bytes / generated bytes
//! 2. sibling temp file in destination dir
//! 3. fsync temp + apply final metadata
//! 4. rename temp over destination atomically
...
// Tests need to create real trees on disk.
